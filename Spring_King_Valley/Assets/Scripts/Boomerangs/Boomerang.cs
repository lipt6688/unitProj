...
namespace Vampire
{
    public class Boomerang : MonoBehaviour
    {
        ...
        {
            if (boomerangSpriteRenderer == null)
                boomerangSpriteRenderer = GetComponentInChildren<SpriteRenderer>(true);
        ...
        public virtual void Setup(int boomerangIndex, Vector2 position, float damage, float knockback, float throwDistance, float throwTime, LayerMask targetLayer)
        {
            ...
            if (boomerangSpriteRenderer != null)
            {
                ...
                Color c = boomerangSpriteRenderer.color;
                if (c.a < 0.55f)
                {
                    c.a = 0.9f;
                    boomerangSpriteRenderer.color = c;
                }
            }
